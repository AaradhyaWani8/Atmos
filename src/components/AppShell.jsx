...
import { AlertTriangle, Activity, BarChart3, Bell, Brain, Info, LayoutDashboard, Map as MapIcon, Settings, Shield, Thermometer, TrendingUp, MapPin } from "lucide-react";
...
function Brand({ onClick }) {
  return <button onClick={onClick} style={{ display: "flex", alignItems: "center", gap: 10, background: "none", border: "none", cursor: onClick ? "pointer" : "default", padding: 0 }}>
    <div style={{ width: 32, height: 32, borderRadius: RADIUS.sm, background: C.charcoal, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><Thermometer size={16} color="#F6F4EF" strokeWidth={1.5} /></div>
...
export default function AppShell({ page, setPage, location, setLocation, onExit, children }) {
