...
export const LOCATIONS = ["Pune", "Mumbai", "Delhi", "Chennai", "Nagpur", "Kolkata", "Ahmedabad"];
...
export const LOCATION_DATA = {
  ...
  Delhi: { temp: 42, feels: 46, humidity: 29, heatIndex: 47, uv: 10, wind: 14, pressure: 1001, aqi: 176, probability: 88, confidence: 93, risk: "HIGH", maxTemp: 45, duration: 3, x: 51, y: 28, state: "Delhi" },
  Chennai: { temp: 37, feels: 43, humidity: 68, heatIndex: 45, uv: 9, wind: 20, pressure: 1005, aqi: 86, probability: 61, confidence: 86, risk: "MODERATE", maxTemp: 40, duration: 2, x: 58, y: 76, state: "Tamil Nadu" },
  Nagpur: { temp: 41, feels: 44, humidity: 31, heatIndex: 46, uv: 10, wind: 12, pressure: 1002, aqi: 121, probability: 79, confidence: 89, risk: "HIGH", maxTemp: 44, duration: 2, x: 55, y: 55, state: "Maharashtra" },
  Kolkata: { temp: 36, feels: 43, humidity: 73, heatIndex: 44, uv: 8, wind: 16, pressure: 1004, aqi: 109, probability: 58, confidence: 84, risk: "MODERATE", maxTemp: 39, duration: 1, x: 76, y: 48, state: "West Bengal" },
  Ahmedabad: { temp: 44, feels: 48, humidity: 25, heatIndex: 50, uv: 11, wind: 11, pressure: 999, aqi: 154, probability: 94, confidence: 95, risk: "EXTREME", maxTemp: 47, duration: 4, x: 28, y: 46, state: "Gujarat" },
};
...
export const AWS_STATIONS = [
  ...
  { id: "#AWS-318", city: "Delhi", status: "Online", battery: "76%", solar: "Stable", sync: "3 mins ago", validation: "Verified" },
];
